 ...
 <aside class="app-layout-drawer">
     ...
     <div class="app-layout-drawer-scroll">
         ...
         <div id="logo" class="drawer-header">
             <a href="index.html"><img class="img-responsive" src="{{asset('assets/img/logo/logo-backend.png')}}"
         ...
         <nav class="drawer-main">
             <ul class="nav nav-drawer">
                 ...
                 <li class="nav-item active">
                     <a href=@if(Auth::user()->user_type == 'member')
                         {{route('member.home')}}
                         @elseif(Auth::user()->user_type == 'internaladmin')
                         {{'dfd'}}
                         @endif>
                         <i class="ion-ios-speedometer-outline"></i> Timeline</a>
                 </li>
                 ...
                 <li class="nav-item nav-item-has-subnav">
                     ...
                     <ul class="nav nav-subnav">
                         ...
                         <li>
                             <a href="{{route('admin.artikel.index')}}">Daftar Artikel</a>
                         </li>

                         <li>
                             <a href="{{route('admin.artikel.create')}}">Buat Artikel</a>
                         </li>
                         <li>
                 ...
                 <li class="nav-item nav-item-has-subnav">
                     <a href="javascript:void(0)"><i class="ion-ios-compose-outline"></i> Banner</a>
                     <ul class="nav nav-subnav">

                         <li>
                             <a href="base_forms_elements.html">Daftar Banner</a>
                         </li>

                         <li>
                             <a href="base_forms_samples.html">Buat Banner</a>
                         </li>

                         <li>
                             <a href="base_forms_validation.html">Pengaturan Banner</a>
                         </li>
                 ...
                 <li class="nav-item nav-item-has-subnav">
                     ...
                     <ul class="nav nav-subnav">
                         ...
                         <li>
                             <a href="{{route('member.artikel.create')}}">Buat Artikel</a>
                         </li>
                         <li>
                             <a href="base_ui_cards.html">Pengaturan Artikel</a>
                         </li>
